// Each value is a CSS hue-rotate degree that shifts the whole bird's palette
// while keeping the shading relationships intact.
const HUE_ROTATIONS = [
  0,    // original — teal-blue wing, peach body
  50,   // green wing, warm body
  105,  // yellow-green wing, cream body
  170,  // coral-red wing, blush body
  215,  // purple wing, lavender body
  270,  // pink wing, rose body
]

export default function SittingBird({ colorIndex = 0, delay = 0, flip = false }) {
  const hue = HUE_ROTATIONS[colorIndex % HUE_ROTATIONS.length]

  return (
    <div style={{ display: 'inline-block', transform: flip ? 'scaleX(-1)' : undefined }}>
    <div style={{
      display: 'inline-block',
      transformOrigin: 'bottom center',
      filter: `hue-rotate(${hue}deg)`,
      animation: [
        `bird-land 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) ${delay}s both`,
        `bird-sway 2.6s ease-in-out ${delay + 0.55}s infinite`,
      ].join(', '),
    }}>
      <svg viewBox="0 0 1024 1024" width={52} height={52} xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M365.86 264.78m-32.45 0a32.45 32.45 0 1 0 64.9 0 32.45 32.45 0 1 0-64.9 0Z" fill="#1a1a1a" />
